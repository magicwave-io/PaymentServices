...
type LocalPPNode interface {
	...
	GetRuntimeState(ctx context.Context) (*entity.RuntimeState, error)
	SetRuntimeState(ctx context.Context, torRoutingMode int) error
...
func (n *nodeImpl) GetRuntimeState(ctx context.Context) (*entity.RuntimeState, error) {
	err := n.db.Open()
	if err != nil {
		return nil, err
	}
	...
	state, err := n.db.SelectRuntimeState()
	if err != nil {
		return nil, err
	}

	return &entity.RuntimeState{
		TorRoutingMode: state.TorRoutingMode,
	}, nil
}

func (n *nodeImpl) SetRuntimeState(ctx context.Context, torRoutingMode int) error {
	err := n.db.Open()
	if err != nil {
		return err
	}
	...
	err = n.db.UpdateRuntimeState(state)
